...
public:
    ...
    void run()
    {
        ...
        #if WIND_ROS_VERSION == 1 
          receiver_ = new wind::wind_ros::Receiver_mad_e2v_madurban();
        #else
          receiver_ = std::make_shared<wind::wind_ros::Receiver_mad_e2v_madurban>();
        #endif
        ...
        slogger_->print() << "Registering message name(" << tools::bold(tools::cyan("EPUtoVehicle")) << ")";
...
private:
      ...
      wind::wind_ros::Receiver_mad_e2v_madurban* receiver_;
    #else
      std::shared_ptr<wind::wind_ros::Receiver_mad_e2v_madurban> receiver_;
    #endif
...
int main(int argc, char** argv) {	
    ...
    slogger->print() << "| " << tools::cyan("Message name") << "       : " << tools::yellow("EPUtoVehicle");
