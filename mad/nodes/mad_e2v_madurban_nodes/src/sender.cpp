...
public:
    ...
    void run() {
        // Modules
          ...
          wind::wind_ros::Sender_mad_e2v_madurban* sender_ = new wind::wind_ros::Sender_mad_e2v_madurban();
		#else
          slogger_->print() << "Starting " << tools::cyan("ROS2") << " node";
		  auto sender_ = std::make_shared<wind::wind_ros::Sender_mad_e2v_madurban>();
	    #endif
