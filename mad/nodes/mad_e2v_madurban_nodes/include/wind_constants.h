...
// Nodes names
#define RECEIVER_NODE_NAME       "mad_e2v_madurban_receiver"
#define SENDER_NODE_NAME         "mad_e2v_madurban_sender"

// Topics
#define RECEIVER_ROS_TOPIC        "/EPUtoVehicle_in"
#define SENDER_ROS_TOPIC          "/EPUtoVehicle_out"

// Network
#define DEFAULT_SENDER_IP          "127.0.0.1" 
#define DEFAULT_SENDER_UDP_PORT    1111          
#define DEFAULT_RECEIVER_UDP_PORT  2030
