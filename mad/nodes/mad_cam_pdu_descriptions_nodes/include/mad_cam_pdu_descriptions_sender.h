 ...
 *
 */
#ifndef MAD_CAM_PDU_DESCRIPTIONS_SENDER_H
#define MAD_CAM_PDU_DESCRIPTIONS_SENDER_H
...
#if WIND_ROS_VERSION == 1
  class Sender_mad_cam_pdu_descriptions
#else
  class Sender_mad_cam_pdu_descriptions : public rclcpp::Node
#endif
{
...
public:
	...
	#if WIND_ROS_VERSION == 1
     Sender_mad_cam_pdu_descriptions() {	
	#else
     Sender_mad_cam_pdu_descriptions() : rclcpp::Node(SENDER_NODE_NAME) {
    #endif		
		messages_counter_ = 0;
		failed_ = 0;
...
private:
    ...
    const int              INDICATION_HEADER_SIZE_ = 52;
	 ...
	 void callback(const mad_cam_pdu_descriptions_msgs::MADCAM::ConstPtr& msg);	 
	#else
	 rclcpp::Subscription<mad_cam_pdu_descriptions_msgs::msg::MADCAM>::SharedPtr subscriber;
     void callback(const std::shared_ptr<mad_cam_pdu_descriptions_msgs::msg::MADCAM>& msg);	 
    #endif
	...
	wind::encoder_mad_cam_pdu_descriptions::WerEncoder* encoder_;
...
#endif //MAD_CAM_PDU_DESCRIPTIONS_SENDER_H