 ...
 *
 */
#ifndef CPM_V2_23_CPM_PDU_DESCRIPTIONS_RECEIVER_H
#define CPM_V2_23_CPM_PDU_DESCRIPTIONS_RECEIVER_H
...
{
	#if WIND_ROS_VERSION == 1
      class Receiver_cpm_v2_23_cpm_pdu_descriptions
	#else
	  class Receiver_cpm_v2_23_cpm_pdu_descriptions : public rclcpp::Node
    #endif
    {
    public:
		...
		Receiver_cpm_v2_23_cpm_pdu_descriptions() : node_handle_("~"),
			...
			busy_(false)
		#else
		Receiver_cpm_v2_23_cpm_pdu_descriptions() : Node("receiver_cpm_v2_23_cpm_pdu_descriptions"),
			messages_counter_(0),
			slogger_(nullptr),
			debug_(false),
			busy_(false)
    ...
    private:        	
		...
		bool            debug_;
		bool            busy_;
		wind::decoder_cpm_v2_23_cpm_pdu_descriptions::WerDecoder* decoder_;
    };
}  // Closing namespace wind_ros
}  // Closing namespace wind

#endif //CPM_V2_23_CPM_PDU_DESCRIPTIONS_RECEIVER_H