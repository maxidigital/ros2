 ...
 *
 */
#ifndef CPM_V2_23_CPM_PDU_DESCRIPTIONS_WER_ENCODER
#define CPM_V2_23_CPM_PDU_DESCRIPTIONS_WER_ENCODER
...
namespace wind
{
    namespace encoder_cpm_v2_23_cpm_pdu_descriptions
    {
        ...
        public:
            ...
            #if WIND_ROS_VERSION == 1
              int encode(const cpm_v2_23_cpm_pdu_descriptions_msgs::CollectivePerceptionMessage::ConstPtr& ros, const uint8_t *buffer);
            #else
              int encode(const std::shared_ptr<cpm_v2_23_cpm_pdu_descriptions_msgs::msg::CollectivePerceptionMessage>& ros, const uint8_t *buffer);
              //int encode(const cpm_v2_23_cpm_pdu_descriptions_msgs::msg::CollectivePerceptionMessage* ros, const uint8_t *buffer);
            #endif
