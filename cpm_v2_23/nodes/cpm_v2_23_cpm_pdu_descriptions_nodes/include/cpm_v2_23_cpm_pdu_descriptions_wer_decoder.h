 ...
 *
 */
#ifndef CPM_V2_23_CPM_PDU_DESCRIPTIONS_WER_DECODER
#define CPM_V2_23_CPM_PDU_DESCRIPTIONS_WER_DECODER
...
namespace wind
{
    namespace decoder_cpm_v2_23_cpm_pdu_descriptions
    {
        ...
        public:
            ...
            #if WIND_ROS_VERSION == 1
              bool decode(cpm_v2_23_cpm_pdu_descriptions_msgs::CollectivePerceptionMessage* ros, const uint8_t *buffer);
            #else
              bool decode(cpm_v2_23_cpm_pdu_descriptions_msgs::msg::CollectivePerceptionMessage* ros, const uint8_t *buffer);
            #endif
...
#endif //CPM_V2_23_CPM_PDU_DESCRIPTIONS_WER_DECODER