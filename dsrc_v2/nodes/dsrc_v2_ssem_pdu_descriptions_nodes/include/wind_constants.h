...
// Nodes names
#define RECEIVER_NODE_NAME       "dsrc_v2_ssem_pdu_descriptions_receiver"
#define SENDER_NODE_NAME         "dsrc_v2_ssem_pdu_descriptions_sender"

// Topics
#define RECEIVER_ROS_TOPIC        "/SSEM_in"
#define SENDER_ROS_TOPIC          "/SSEM_out"

// Network
#define DEFAULT_SENDER_IP          "127.0.0.1" 
#define DEFAULT_SENDER_UDP_PORT    1111          
#define DEFAULT_RECEIVER_UDP_PORT  2008
