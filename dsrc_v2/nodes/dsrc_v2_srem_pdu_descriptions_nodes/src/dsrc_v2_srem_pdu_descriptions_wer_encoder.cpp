...
namespace wind
{
    ...
    // Field:  type(SignalRequestMessage) name(srm) extGroup(0)
        ...
        *_tmp_5 = (ros->srm.sequence_number.size() != 0 ? 1 : 0);
        if(debug)
            logger->print() << "|" << tools::brown("000004") << "| Optional field sequence_number = " << *_tmp_5;
        char* _tmp_6 = (char*) buffer++;
        *_tmp_6 = (ros->srm.requests.size() != 0 ? 1 : 0);
        if(debug)
            logger->print() << "|" << tools::brown("000005") << "| Optional field requests = " << *_tmp_6;
        char* _tmp_7 = (char*) buffer++;
        *_tmp_7 = (ros->srm.regional.size() != 0 ? 1 : 0);
        if(debug)
            logger->print() << "|" << tools::brown("000006") << "| Optional field regional = " << *_tmp_7;
        
        if(ros->srm.time_stamp.size() == 1) {
            // Field:  type(MinuteOfTheYear) name(time_stamp) extGroup(0)
            // Integer
            
            // UINT32  min(0) max(527040) span(527041) dataType(UInt32)
            if(debug) {
                logger->print() << "|" << tools::brown("000007") << "| " << tools::getTypeName(ros->srm.time_stamp[0].value) << 
            ...
            *_tmp_8 = ros->srm.time_stamp[0].value; 
            ...
            // MIN validator
            if (VALIDATORS_ENABLED && __aux64__ < 0) {
                logger->error() << "Error: Value in 'srm.time_stamp[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                return -1;
            }
            // MAX validator
        ...
        else if(ros->srm.time_stamp.size() > 1) {
            logger->error() << "Error: In 'ros->srm.time_stamp', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
            return -1;
        }
        ...
        if(debug) {
            logger->print() << "|" << tools::brown("000008") << "| " << tools::getTypeName(ros->srm.second.value) << 
        ...
        *_tmp_9 = ros->srm.second.value; 
        ...
        // MIN validator
        if (VALIDATORS_ENABLED && __aux64__ < 0) {
            logger->error() << "Error: Value in 'srm.second.value' (" << __aux64__ << ") less than (0); message dropped.";
            return -1;
        }
        // MAX validator
        ...
        if(ros->srm.sequence_number.size() == 1) {
            // Field:  type(MsgCount) name(sequence_number) extGroup(0)
            // Integer
            
            // UINT8  min(0) max(127) span(128) dataType(UInt8)
            if(debug) {
                logger->print() << "|" << tools::brown("000009") << "| " << tools::getTypeName(ros->srm.sequence_number[0].value) << 
            ...
            *_tmp_10 = ros->srm.sequence_number[0].value; 
            ...
            // MIN validator
            if (VALIDATORS_ENABLED && __aux64__ < 0) {
                logger->error() << "Error: Value in 'srm.sequence_number[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                return -1;
            }
            // MAX validator
        ...
        else if(ros->srm.sequence_number.size() > 1) {
            logger->error() << "Error: In 'ros->srm.sequence_number', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
            return -1;
        }
        
        if(ros->srm.requests.size() == 1) {
            ...
            *_tmp_11 = __aux64__ - 1;
            ...
            for(int a = 0; a < __ifa; a++) { 
                    ...
                    *_tmp_12 = (ros->srm.requests[0].elements[a].minute.size() != 0 ? 1 : 0);
                    if(debug)
                        logger->print() << "|" << tools::brown("000011") << "| Optional field minute = " << *_tmp_12;
                    char* _tmp_13 = (char*) buffer++;
                    *_tmp_13 = (ros->srm.requests[0].elements[a].second.size() != 0 ? 1 : 0);
                    if(debug)
                        logger->print() << "|" << tools::brown("000012") << "| Optional field second = " << *_tmp_13;
                    char* _tmp_14 = (char*) buffer++;
                    *_tmp_14 = (ros->srm.requests[0].elements[a].duration.size() != 0 ? 1 : 0);
                    if(debug)
                        logger->print() << "|" << tools::brown("000013") << "| Optional field duration = " << *_tmp_14;
                    ...
                    *_tmp_15 = (ros->srm.requests[0].elements[a].regional.size() != 0 ? 1 : 0);
                    ...
                    // Field:  type(SignalRequest) name(request) extGroup(0)
                        ...
                        *_tmp_16 = (ros->srm.requests[0].elements[a].request.out_bound_lane.size() != 0 ? 1 : 0);
                        if(debug)
                            logger->print() << "|" << tools::brown("000015") << "| Optional field out_bound_lane = " << *_tmp_16;
                        char* _tmp_17 = (char*) buffer++;
                        *_tmp_17 = (ros->srm.requests[0].elements[a].request.regional.size() != 0 ? 1 : 0);
                        if(debug)
                            logger->print() << "|" << tools::brown("000016") << "| Optional field regional = " << *_tmp_17;
                        ...
                        // Field:  type(IntersectionReferenceID) name(id) extGroup(0)
                            ...
                            *_tmp_18 = (ros->srm.requests[0].elements[a].request.id.region.size() != 0 ? 1 : 0);
                            if(debug)
                                logger->print() << "|" << tools::brown("000017") << "| Optional field region = " << *_tmp_18;
                            
                            if(ros->srm.requests[0].elements[a].request.id.region.size() == 1) {
                                // Field:  type(RoadRegulatorID) name(region) extGroup(0)
                                // Integer
                                
                                // UINT16  min(0) max(65535) span(65536) dataType(UInt16)
                                if(debug) {
                                    logger->print() << "|" << tools::brown("000018") << "| " << tools::getTypeName(ros->srm.requests[0].elements[a].request.id.region[0].value) << 
                                ...
                                *_tmp_19 = ros->srm.requests[0].elements[a].request.id.region[0].value; 
                                ...
                                // MIN validator
                                if (VALIDATORS_ENABLED && __aux64__ < 0) {
                                    logger->error() << "Error: Value in 'srm.requests[0].elements[a].request.id.region[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                                    return -1;
                                }
                                // MAX validator
                                if (VALIDATORS_ENABLED && __aux64__ > 65535) {
                            ...
                            else if(ros->srm.requests[0].elements[a].request.id.region.size() > 1) {
                                logger->error() << "Error: In 'ros->srm.requests[0].elements[a].request.id.region', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                                return -1;
                            }
                            ...
                            // UINT16  min(0) max(65535) span(65536) dataType(UInt16)
                            if(debug) {
                                logger->print() << "|" << tools::brown("000019") << "| " << tools::getTypeName(ros->srm.requests[0].elements[a].request.id.id.value) << 
                            ...
                            *_tmp_20 = ros->srm.requests[0].elements[a].request.id.id.value; 
                            ...
                            // MIN validator
                            if (VALIDATORS_ENABLED && __aux64__ < 0) {
                                logger->error() << "Error: Value in 'srm.requests[0].elements[a].request.id.id.value' (" << __aux64__ << ") less than (0); message dropped.";
                                return -1;
                            }
                            // MAX validator
                            if (VALIDATORS_ENABLED && __aux64__ > 65535) {
                        ...
                        // UINT8  min(0) max(255) span(256) dataType(UInt8)
                        if(debug) {
                            logger->print() << "|" << tools::brown("000020") << "| " << tools::getTypeName(ros->srm.requests[0].elements[a].request.request_id.value) << 
                        ...
                        *_tmp_21 = ros->srm.requests[0].elements[a].request.request_id.value; 
                        ...
                        // MIN validator
                        if (VALIDATORS_ENABLED && __aux64__ < 0) {
                            logger->error() << "Error: Value in 'srm.requests[0].elements[a].request.request_id.value' (" << __aux64__ << ") less than (0); message dropped.";
                            return -1;
                        }
                        // MAX validator
                        if (VALIDATORS_ENABLED && __aux64__ > 255) {
                        ...
                        if(debug) {
                            logger->print() << "|" << tools::brown("000021") << "| " << tools::getTypeName(ros->srm.requests[0].elements[a].request.request_type.value) << 
                        ...
                        *_tmp_22 = ros->srm.requests[0].elements[a].request.request_type.value; 
                        ...
                        // MIN validator
                        if (VALIDATORS_ENABLED && __aux64__ < 0) {
                            logger->error() << "Error: Value in 'srm.requests[0].elements[a].request.request_type.value' (" << __aux64__ << ") less than (0); message dropped.";
                            return -1;
                        }
                        // MAX validator
                        ...
                        *_ext_flag_14 = 0; 
                        ...
                        if(ros->srm.requests[0].elements[a].request.in_bound_lane.lane.size() != 0) {  // CHOICE 0  fieldType(IntersectionAccessPoint) 
                            *_choice_1 = 0;  // Setting choice selection
                            ...
                            if(debug)
                                logger->debug() << "|" << tools::brown("000022") << "| Choice selection: 0";
                        
                            // Integer
                            
                            // UINT8  min(0) max(255) span(256) dataType(UInt8)
                            if(debug) {
                                logger->print() << "|" << tools::brown("000023") << "| " << tools::getTypeName(ros->srm.requests[0].elements[a].request.in_bound_lane.lane[0].value) << 
                            ...
                            *_tmp_23 = ros->srm.requests[0].elements[a].request.in_bound_lane.lane[0].value; 
                            ...
                            // MIN validator
                            if (VALIDATORS_ENABLED && __aux64__ < 0) {
                                logger->error() << "Error: Value in 'srm.requests[0].elements[a].request.in_bound_lane.lane[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                                return -1;
                            }
                            // MAX validator
                            if (VALIDATORS_ENABLED && __aux64__ > 255) {
                        ...
                        else if(ros->srm.requests[0].elements[a].request.in_bound_lane.approach.size() != 0)  // CHOICE 1  fieldType(IntersectionAccessPoint) 
                        {
                            *_choice_1 = 1;  // Setting choice selection
                            ...
                            if(debug)
                                logger->debug() << "|" << tools::brown("000024") << "| Choice selection: 1";
                        
                            // Integer
                            
                            // UINT8  min(0) max(15) span(16) dataType(UInt8)
                            if(debug) {
                                logger->print() << "|" << tools::brown("000025") << "| " << tools::getTypeName(ros->srm.requests[0].elements[a].request.in_bound_lane.approach[0].value) << 
                            ...
                            *_tmp_24 = ros->srm.requests[0].elements[a].request.in_bound_lane.approach[0].value; 
                            ...
                            // MIN validator
                            if (VALIDATORS_ENABLED && __aux64__ < 0) {
                                logger->error() << "Error: Value in 'srm.requests[0].elements[a].request.in_bound_lane.approach[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                                return -1;
                            }
                            // MAX validator
                        ...
                        else if(ros->srm.requests[0].elements[a].request.in_bound_lane.connection.size() != 0)  // CHOICE 2  fieldType(IntersectionAccessPoint) 
                        {
                            *_choice_1 = 2;  // Setting choice selection
                            ...
                            if(debug)
                                logger->debug() << "|" << tools::brown("000026") << "| Choice selection: 2";
                        
                            // Integer
                            
                            // UINT8  min(0) max(255) span(256) dataType(UInt8)
                            if(debug) {
                                logger->print() << "|" << tools::brown("000027") << "| " << tools::getTypeName(ros->srm.requests[0].elements[a].request.in_bound_lane.connection[0].value) << 
                            ...
                            *_tmp_25 = ros->srm.requests[0].elements[a].request.in_bound_lane.connection[0].value; 
                            ...
                            // MIN validator
                            if (VALIDATORS_ENABLED && __aux64__ < 0) {
                                logger->error() << "Error: Value in 'srm.requests[0].elements[a].request.in_bound_lane.connection[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                                return -1;
                            }
                            // MAX validator
                            if (VALIDATORS_ENABLED && __aux64__ > 255) {
                        ...
                        if(ros->srm.requests[0].elements[a].request.out_bound_lane.size() == 1) {
                            ...
                            *_ext_flag_18 = 0; 
                            ...
                            if(ros->srm.requests[0].elements[a].request.out_bound_lane[0].lane.size() != 0) {  // CHOICE 0  fieldType(IntersectionAccessPoint) 
                                *_choice_2 = 0;  // Setting choice selection
                                ...
                                if(debug)
                                    logger->debug() << "|" << tools::brown("000028") << "| Choice selection: 0";
                                ...
                                *_tmp_26 = ros->srm.requests[0].elements[a].request.out_bound_lane[0].lane[0].value; 
                                ...
                                // MIN validator
                                if (VALIDATORS_ENABLED && __aux64__ < 0) {
                                    logger->error() << "Error: Value in 'srm.requests[0].elements[a].request.out_bound_lane[0].lane[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                                    return -1;
                                }
                                // MAX validator
                                if (VALIDATORS_ENABLED && __aux64__ > 255) {
                            ...
                            else if(ros->srm.requests[0].elements[a].request.out_bound_lane[0].approach.size() != 0)  // CHOICE 1  fieldType(IntersectionAccessPoint) 
                            {
                                *_choice_2 = 1;  // Setting choice selection
                                ...
                                if(debug)
                                    logger->debug() << "|" << tools::brown("000030") << "| Choice selection: 1";
                            
                                // Integer
                                
                                // UINT8  min(0) max(15) span(16) dataType(UInt8)
                                if(debug) {
                                    logger->print() << "|" << tools::brown("000031") << "| " << tools::getTypeName(ros->srm.requests[0].elements[a].request.out_bound_lane[0].approach[0].value) << 
                                ...
                                *_tmp_27 = ros->srm.requests[0].elements[a].request.out_bound_lane[0].approach[0].value; 
                                ...
                                // MIN validator
                                if (VALIDATORS_ENABLED && __aux64__ < 0) {
                                    logger->error() << "Error: Value in 'srm.requests[0].elements[a].request.out_bound_lane[0].approach[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                                    return -1;
                                }
                                // MAX validator
                                if (VALIDATORS_ENABLED && __aux64__ > 15) {
                            ...
                            else if(ros->srm.requests[0].elements[a].request.out_bound_lane[0].connection.size() != 0)  // CHOICE 2  fieldType(IntersectionAccessPoint) 
                            {
                                *_choice_2 = 2;  // Setting choice selection
                                ...
                                if(debug)
                                    logger->debug() << "|" << tools::brown("000032") << "| Choice selection: 2";
                            
                                // Integer
                                
                                // UINT8  min(0) max(255) span(256) dataType(UInt8)
                                if(debug) {
                                    logger->print() << "|" << tools::brown("000033") << "| " << tools::getTypeName(ros->srm.requests[0].elements[a].request.out_bound_lane[0].connection[0].value) << 
                                ...
                                *_tmp_28 = ros->srm.requests[0].elements[a].request.out_bound_lane[0].connection[0].value; 
                                ...
                                // MIN validator
                                if (VALIDATORS_ENABLED && __aux64__ < 0) {
                                    logger->error() << "Error: Value in 'srm.requests[0].elements[a].request.out_bound_lane[0].connection[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                                    return -1;
                                }
                                // MAX validator
                                if (VALIDATORS_ENABLED && __aux64__ > 255) {
                        ...
                        else if(ros->srm.requests[0].elements[a].request.out_bound_lane.size() > 1) {
                            logger->error() << "Error: In 'ros->srm.requests[0].elements[a].request.out_bound_lane', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                            return -1;
                        }
                    ...
                    if(ros->srm.requests[0].elements[a].minute.size() == 1) {
                        // Field:  type(MinuteOfTheYear) name(minute) extGroup(0)
                        // Integer
                        
                        // UINT32  min(0) max(527040) span(527041) dataType(UInt32)
                        if(debug) {
                            logger->print() << "|" << tools::brown("000034") << "| " << tools::getTypeName(ros->srm.requests[0].elements[a].minute[0].value) << 
                        ...
                        *_tmp_30 = ros->srm.requests[0].elements[a].minute[0].value; 
                        ...
                        // MIN validator
                        if (VALIDATORS_ENABLED && __aux64__ < 0) {
                            logger->error() << "Error: Value in 'srm.requests[0].elements[a].minute[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                            return -1;
                        }
                        // MAX validator
                        if (VALIDATORS_ENABLED && __aux64__ > 527040) {
                    ...
                    else if(ros->srm.requests[0].elements[a].minute.size() > 1) {
                        logger->error() << "Error: In 'ros->srm.requests[0].elements[a].minute', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                        return -1;
                    }
                    
                    if(ros->srm.requests[0].elements[a].second.size() == 1) {
                        // Field:  type(DSecond) name(second) extGroup(0)
                        // Integer
                        
                        // UINT16  min(0) max(65535) span(65536) dataType(UInt16)
                        if(debug) {
                            logger->print() << "|" << tools::brown("000035") << "| " << tools::getTypeName(ros->srm.requests[0].elements[a].second[0].value) << 
                        ...
                        *_tmp_31 = ros->srm.requests[0].elements[a].second[0].value; 
                        ...
                        // MIN validator
                        if (VALIDATORS_ENABLED && __aux64__ < 0) {
                            logger->error() << "Error: Value in 'srm.requests[0].elements[a].second[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                            return -1;
                        }
                        // MAX validator
                        if (VALIDATORS_ENABLED && __aux64__ > 65535) {
                    ...
                    else if(ros->srm.requests[0].elements[a].second.size() > 1) {
                        logger->error() << "Error: In 'ros->srm.requests[0].elements[a].second', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                        return -1;
                    }
                    
                    if(ros->srm.requests[0].elements[a].duration.size() == 1) {
                        // Field:  type(DSecond) name(duration) extGroup(0)
                        // Integer
                        
                        // UINT16  min(0) max(65535) span(65536) dataType(UInt16)
                        if(debug) {
                            logger->print() << "|" << tools::brown("000036") << "| " << tools::getTypeName(ros->srm.requests[0].elements[a].duration[0].value) << 
                        ...
                        *_tmp_32 = ros->srm.requests[0].elements[a].duration[0].value; 
                        ...
                        // MIN validator
                        if (VALIDATORS_ENABLED && __aux64__ < 0) {
                            logger->error() << "Error: Value in 'srm.requests[0].elements[a].duration[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                            return -1;
                        }
                        // MAX validator
                        if (VALIDATORS_ENABLED && __aux64__ > 65535) {
                    ...
                    else if(ros->srm.requests[0].elements[a].duration.size() > 1) {
                        logger->error() << "Error: In 'ros->srm.requests[0].elements[a].duration', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                        return -1;
                    }
        ...
        else if(ros->srm.requests.size() > 1) {
            logger->error() << "Error: In 'ros->srm.requests', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
            return -1;
        }
        ...
        // Field:  type(RequestorDescription) name(requestor) extGroup(0)
            ...
            *_tmp_34 = (ros->srm.requestor.type.size() != 0 ? 1 : 0);
            if(debug)
                logger->print() << "|" << tools::brown("000037") << "| Optional field type = " << *_tmp_34;
            char* _tmp_35 = (char*) buffer++;
            *_tmp_35 = (ros->srm.requestor.position.size() != 0 ? 1 : 0);
            if(debug)
                logger->print() << "|" << tools::brown("000038") << "| Optional field position = " << *_tmp_35;
            char* _tmp_36 = (char*) buffer++;
            *_tmp_36 = (ros->srm.requestor.name.size() != 0 ? 1 : 0);
            if(debug)
                logger->print() << "|" << tools::brown("000039") << "| Optional field name = " << *_tmp_36;
            char* _tmp_37 = (char*) buffer++;
            *_tmp_37 = (ros->srm.requestor.route_name.size() != 0 ? 1 : 0);
            if(debug)
                logger->print() << "|" << tools::brown("000040") << "| Optional field route_name = " << *_tmp_37;
            char* _tmp_38 = (char*) buffer++;
            *_tmp_38 = (ros->srm.requestor.transit_status.size() != 0 ? 1 : 0);
            if(debug)
                logger->print() << "|" << tools::brown("000041") << "| Optional field transit_status = " << *_tmp_38;
            char* _tmp_39 = (char*) buffer++;
            *_tmp_39 = (ros->srm.requestor.transit_occupancy.size() != 0 ? 1 : 0);
            if(debug)
                logger->print() << "|" << tools::brown("000042") << "| Optional field transit_occupancy = " << *_tmp_39;
            char* _tmp_40 = (char*) buffer++;
            *_tmp_40 = (ros->srm.requestor.transit_schedule.size() != 0 ? 1 : 0);
            if(debug)
                logger->print() << "|" << tools::brown("000043") << "| Optional field transit_schedule = " << *_tmp_40;
            char* _tmp_41 = (char*) buffer++;
            *_tmp_41 = (ros->srm.requestor.regional.size() != 0 ? 1 : 0);
            if(debug)
                logger->print() << "|" << tools::brown("000044") << "| Optional field regional = " << *_tmp_41;
            ...
            if(ros->srm.requestor.id.entity_id.size() != 0) {  // CHOICE 0  fieldType(VehicleID) 
                *_choice_3 = 0;  // Setting choice selection
                ...
                if(debug)
                    logger->debug() << "|" << tools::brown("000045") << "| Choice selection: 0";
            
                // OctetString
                // OCTET_STRING  min(4) max(4) span(1)
                
                if(debug)
                    logger->print() << "|" << tools::brown("000046") << "| srm.requestor.id.entity_id[0].values.size(): srm.requestor.id.entity_id[0]" << static_cast<int>(ros->srm.requestor.id.entity_id[0].values.size());
            ...
            else if(ros->srm.requestor.id.station_id.size() != 0)  // CHOICE 1  fieldType(VehicleID) 
            {
                *_choice_3 = 1;  // Setting choice selection
                ...
                // UINT32  min(0) max(4294967295) span(4294967296) dataType(UInt32)
                if(debug) {
                    logger->print() << "|" << tools::brown("000048") << "| " << tools::getTypeName(ros->srm.requestor.id.station_id[0].value) << 
                ...
                *_tmp_43 = ros->srm.requestor.id.station_id[0].value; 
                ...
                // MIN validator
                if (VALIDATORS_ENABLED && __aux64__ < 0) {
                    logger->error() << "Error: Value in 'srm.requestor.id.station_id[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                    return -1;
                }
                // MAX validator
                if (VALIDATORS_ENABLED && __aux64__ > 4294967295) {
            ...
            if(ros->srm.requestor.type.size() == 1) {
                // Field:  type(RequestorType) name(type) extGroup(0)
                    ...
                    *_tmp_44 = (ros->srm.requestor.type[0].subrole.size() != 0 ? 1 : 0);
                    if(debug)
                        logger->print() << "|" << tools::brown("000049") << "| Optional field subrole = " << *_tmp_44;
                    char* _tmp_45 = (char*) buffer++;
                    *_tmp_45 = (ros->srm.requestor.type[0].request.size() != 0 ? 1 : 0);
                    if(debug)
                        logger->print() << "|" << tools::brown("000050") << "| Optional field request = " << *_tmp_45;
                    char* _tmp_46 = (char*) buffer++;
                    *_tmp_46 = (ros->srm.requestor.type[0].iso3883.size() != 0 ? 1 : 0);
                    if(debug)
                        logger->print() << "|" << tools::brown("000051") << "| Optional field iso3883 = " << *_tmp_46;
                    char* _tmp_47 = (char*) buffer++;
                    *_tmp_47 = (ros->srm.requestor.type[0].hpms_type.size() != 0 ? 1 : 0);
                    if(debug)
                        logger->print() << "|" << tools::brown("000052") << "| Optional field hpms_type = " << *_tmp_47;
                    char* _tmp_48 = (char*) buffer++;
                    *_tmp_48 = (ros->srm.requestor.type[0].regional.size() != 0 ? 1 : 0);
                    if(debug)
                        logger->print() << "|" << tools::brown("000053") << "| Optional field regional = " << *_tmp_48;
                    ...
                    *_tmp_49 = ros->srm.requestor.type[0].role.value; 
                    ...
                    // MIN validator
                    if (VALIDATORS_ENABLED && __aux64__ < 0) {
                        logger->error() << "Error: Value in 'srm.requestor.type[0].role.value' (" << __aux64__ << ") less than (0); message dropped.";
                        return -1;
                    }
                    // MAX validator
                    ...
                    if(ros->srm.requestor.type[0].subrole.size() == 1) {
                        ...
                        *_tmp_50 = ros->srm.requestor.type[0].subrole[0].value; 
                        ...
                        // MIN validator
                        if (VALIDATORS_ENABLED && __aux64__ < 0) {
                            logger->error() << "Error: Value in 'srm.requestor.type[0].subrole[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                            return -1;
                        }
                        // MAX validator
                        if (VALIDATORS_ENABLED && __aux64__ > 15) {
                    ...
                    else if(ros->srm.requestor.type[0].subrole.size() > 1) {
                        logger->error() << "Error: In 'ros->srm.requestor.type[0].subrole', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                        return -1;
                    }
                    
                    if(ros->srm.requestor.type[0].request.size() == 1) {
                        ...
                        *_tmp_51 = ros->srm.requestor.type[0].request[0].value; 
                        ...
                        // MIN validator
                        if (VALIDATORS_ENABLED && __aux64__ < 0) {
                            logger->error() << "Error: Value in 'srm.requestor.type[0].request[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                            return -1;
                        }
                        // MAX validator
                        if (VALIDATORS_ENABLED && __aux64__ > 15) {
                    ...
                    else if(ros->srm.requestor.type[0].request.size() > 1) {
                        logger->error() << "Error: In 'ros->srm.requestor.type[0].request', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                        return -1;
                    }
                    
                    if(ros->srm.requestor.type[0].iso3883.size() == 1) {
                        ...
                        *_tmp_52 = ros->srm.requestor.type[0].iso3883[0].value; 
                        ...
                        // MIN validator
                        if (VALIDATORS_ENABLED && __aux64__ < 0) {
                            logger->error() << "Error: Value in 'srm.requestor.type[0].iso3883[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                            return -1;
                        }
                        // MAX validator
                        if (VALIDATORS_ENABLED && __aux64__ > 255) {
                    ...
                    else if(ros->srm.requestor.type[0].iso3883.size() > 1) {
                        logger->error() << "Error: In 'ros->srm.requestor.type[0].iso3883', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                        return -1;
                    }
                    
                    if(ros->srm.requestor.type[0].hpms_type.size() == 1) {
                        ...
                        if(debug) {
                            logger->print() << "|" << tools::brown("000058") << "| " << tools::getTypeName(ros->srm.requestor.type[0].hpms_type[0].value) << 
                        ...
                        *_tmp_53 = ros->srm.requestor.type[0].hpms_type[0].value; 
                        ...
                        // MIN validator
                        if (VALIDATORS_ENABLED && __aux64__ < 0) {
                            logger->error() << "Error: Value in 'srm.requestor.type[0].hpms_type[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                            return -1;
                        }
                        // MAX validator
                        if (VALIDATORS_ENABLED && __aux64__ > 15) {
                    ...
                    else if(ros->srm.requestor.type[0].hpms_type.size() > 1) {
                        logger->error() << "Error: In 'ros->srm.requestor.type[0].hpms_type', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                        return -1;
                    }
            ...
            else if(ros->srm.requestor.type.size() > 1) {
                logger->error() << "Error: In 'ros->srm.requestor.type', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                return -1;
            }
            
            if(ros->srm.requestor.position.size() == 1) {
                // Field:  type(RequestorPositionVector) name(position) extGroup(0)
                    ...
                    *_tmp_55 = (ros->srm.requestor.position[0].heading.size() != 0 ? 1 : 0);
                    if(debug)
                        logger->print() << "|" << tools::brown("000059") << "| Optional field heading = " << *_tmp_55;
                    char* _tmp_56 = (char*) buffer++;
                    *_tmp_56 = (ros->srm.requestor.position[0].speed.size() != 0 ? 1 : 0);
                    if(debug)
                        logger->print() << "|" << tools::brown("000060") << "| Optional field speed = " << *_tmp_56;
                    ...
                    // Field:  type(Position3D) name(position) extGroup(0)
                        ...
                        *_tmp_57 = (ros->srm.requestor.position[0].position.elevation.size() != 0 ? 1 : 0);
                        if(debug)
                            logger->print() << "|" << tools::brown("000061") << "| Optional field elevation = " << *_tmp_57;
                        char* _tmp_58 = (char*) buffer++;
                        *_tmp_58 = (ros->srm.requestor.position[0].position.regional.size() != 0 ? 1 : 0);
                        if(debug)
                            logger->print() << "|" << tools::brown("000062") << "| Optional field regional = " << *_tmp_58;
                        ...
                        if(debug) {
                            logger->print() << "|" << tools::brown("000063") << "| " << tools::getTypeName(ros->srm.requestor.position[0].position.lat.value) << 
                        ...
                        *_tmp_59 = static_cast<uint32_t>(_tmp_60);
                        ...
                        if (VALIDATORS_ENABLED && __aux64__ < -900000000) {
                            logger->error() << "Error: Value in 'srm.requestor.position[0].position.lat.value' (" << __aux64__ << ") less than (-900000000); message dropped.";
                            return -1;
                        }
                        // MAX validator
                        ...
                        if(debug) {
                            logger->print() << "|" << tools::brown("000064") << "| " << tools::getTypeName(ros->srm.requestor.position[0].position.longint.value) << 
                        ...
                        *_tmp_61 = static_cast<uint32_t>(_tmp_62);
                        ...
                        if (VALIDATORS_ENABLED && __aux64__ < -1800000000) {
                            logger->error() << "Error: Value in 'srm.requestor.position[0].position.longint.value' (" << __aux64__ << ") less than (-1800000000); message dropped.";
                            return -1;
                        }
                        // MAX validator
                        ...
                        if(ros->srm.requestor.position[0].position.elevation.size() == 1) {
                            // Field:  type(Elevation) name(elevation) extGroup(0)
                            // Real
                            
                            // FLOAT  min(-4096) max(61439) span(65536) scaleDivisor(10.0) dataType(Float)
                            if(debug) {
                                logger->print() << "|" << tools::brown("000065") << "| " << tools::getTypeName(ros->srm.requestor.position[0].position.elevation[0].value) << 
                            ...
                            *_tmp_63 = static_cast<uint16_t>(_tmp_64);
                            ...
                            if (VALIDATORS_ENABLED && __aux64__ < -4096) {
                                logger->error() << "Error: Value in 'srm.requestor.position[0].position.elevation[0].value' (" << __aux64__ << ") less than (-4096); message dropped.";
                                return -1;
                            }
                            // MAX validator
                        ...
                        else if(ros->srm.requestor.position[0].position.elevation.size() > 1) {
                            logger->error() << "Error: In 'ros->srm.requestor.position[0].position.elevation', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                            return -1;
                        }
                    ...
                    if(ros->srm.requestor.position[0].heading.size() == 1) {
                        // Field:  type(Angle) name(heading) extGroup(0)
                        // Integer
                        
                        // UINT16  min(0) max(28800) span(28801) dataType(UInt16)
                        if(debug) {
                            logger->print() << "|" << tools::brown("000066") << "| " << tools::getTypeName(ros->srm.requestor.position[0].heading[0].value) << 
                        ...
                        *_tmp_66 = ros->srm.requestor.position[0].heading[0].value; 
                        ...
                        // MIN validator
                        if (VALIDATORS_ENABLED && __aux64__ < 0) {
                            logger->error() << "Error: Value in 'srm.requestor.position[0].heading[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                            return -1;
                        }
                        // MAX validator
                    ...
                    else if(ros->srm.requestor.position[0].heading.size() > 1) {
                        logger->error() << "Error: In 'ros->srm.requestor.position[0].heading', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                        return -1;
                    }
                    
                    if(ros->srm.requestor.position[0].speed.size() == 1) {
                        // Field:  type(TransmissionAndSpeed) name(speed) extGroup(0)
                            ...
                            if(debug) {
                                logger->print() << "|" << tools::brown("000067") << "| " << tools::getTypeName(ros->srm.requestor.position[0].speed[0].transmisson.value) << 
                            ...
                            *_tmp_67 = ros->srm.requestor.position[0].speed[0].transmisson.value; 
                            ...
                            // MIN validator
                            if (VALIDATORS_ENABLED && __aux64__ < 0) {
                                logger->error() << "Error: Value in 'srm.requestor.position[0].speed[0].transmisson.value' (" << __aux64__ << ") less than (0); message dropped.";
                                return -1;
                            }
                            // MAX validator
                            ...
                            if(debug) {
                                logger->print() << "|" << tools::brown("000068") << "| " << tools::getTypeName(ros->srm.requestor.position[0].speed[0].speed.value) << 
                            ...
                            *_tmp_68 = ros->srm.requestor.position[0].speed[0].speed.value; 
                            ...
                            // MIN validator
                            if (VALIDATORS_ENABLED && __aux64__ < 0) {
                                logger->error() << "Error: Value in 'srm.requestor.position[0].speed[0].speed.value' (" << __aux64__ << ") less than (0); message dropped.";
                                return -1;
                            }
                            // MAX validator
                    ...
                    else if(ros->srm.requestor.position[0].speed.size() > 1) {
                        logger->error() << "Error: In 'ros->srm.requestor.position[0].speed', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                        return -1;
                    }
            ...
            else if(ros->srm.requestor.position.size() > 1) {
                logger->error() << "Error: In 'ros->srm.requestor.position', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                return -1;
            }
            
            if(ros->srm.requestor.name.size() == 1) {
                ...
                if(debug)
                    logger->print() << "|" << tools::brown("000069") << "| srm.requestor.name[0].value.size(): " << 
            ...
            else if(ros->srm.requestor.name.size() > 1) {
                logger->error() << "Error: In 'ros->srm.requestor.name', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                return -1;
            }
            
            if(ros->srm.requestor.route_name.size() == 1) {
                ...
                if(debug)
                    logger->print() << "|" << tools::brown("000070") << "| srm.requestor.route_name[0].value.size(): " << 
            ...
            else if(ros->srm.requestor.route_name.size() > 1) {
                logger->error() << "Error: In 'ros->srm.requestor.route_name', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                return -1;
            }
            
            if(ros->srm.requestor.transit_status.size() == 1) {
                // Field:  type(TransitVehicleStatus) name(transit_status) extGroup(0)
                // BitString
                // BIT_STRING  min(8) max(8) span(1)
                if(debug)
                    logger->print() << "|" << tools::brown("000071") << "| srm.requestor.transit_status[0].value: " << static_cast<int>(ros->srm.requestor.transit_status[0].values.size());
            ...
            else if(ros->srm.requestor.transit_status.size() > 1) {
                logger->error() << "Error: In 'ros->srm.requestor.transit_status', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                return -1;
            }
            
            if(ros->srm.requestor.transit_occupancy.size() == 1) {
                // Field:  type(TransitVehicleOccupancy) name(transit_occupancy) extGroup(0)
                // Enumerated
                // INT32  min(0) max(7) span(8) dataType(Int32)
                if(debug) {
                    logger->print() << "|" << tools::brown("000072") << "| " << tools::getTypeName(ros->srm.requestor.transit_occupancy[0].value) << 
                ...
                *_tmp_73 = ros->srm.requestor.transit_occupancy[0].value; 
                ...
                // MIN validator
                if (VALIDATORS_ENABLED && __aux64__ < 0) {
                    logger->error() << "Error: Value in 'srm.requestor.transit_occupancy[0].value' (" << __aux64__ << ") less than (0); message dropped.";
                    return -1;
                }
                // MAX validator
                if (VALIDATORS_ENABLED && __aux64__ > 7) {
            ...
            else if(ros->srm.requestor.transit_occupancy.size() > 1) {
                logger->error() << "Error: In 'ros->srm.requestor.transit_occupancy', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                return -1;
            }
            
            if(ros->srm.requestor.transit_schedule.size() == 1) {
                // Field:  type(DeltaTime) name(transit_schedule) extGroup(0)
                // Integer
                
                // INT8  min(-122) max(121) span(244) dataType(Int8)
                if(debug) {
                    logger->print() << "|" << tools::brown("000073") << "| " << tools::getTypeName(ros->srm.requestor.transit_schedule[0].value) << 
                ...
                *_tmp_74 = __aux64__;
                ...
                if (VALIDATORS_ENABLED && __aux64__ < -122) {
                    logger->error() << "Error: Value in 'srm.requestor.transit_schedule[0].value' (" << __aux64__ << ") less than (-122); message dropped.";
                    return -1;
                }
                // MAX validator
            ...
            else if(ros->srm.requestor.transit_schedule.size() > 1) {
                logger->error() << "Error: In 'ros->srm.requestor.transit_schedule', invalid optional field implementation. Optional fields must contain 0 elements (not present) or 1 element (present). Multiple elements are not allowed. Message dropped.";
                return -1;
            }
