...
public:
    ...
    void run()
    {
        ...
        #if WIND_ROS_VERSION == 1 
		  receiver_ = new wind::wind_ros::Receiver_dsrc_v2_mapem_pdu_descriptions();
		#else
          receiver_ = std::make_shared<wind::wind_ros::Receiver_dsrc_v2_mapem_pdu_descriptions>();
		#endif
...
private:
      ...
      wind::wind_ros::Receiver_dsrc_v2_mapem_pdu_descriptions* receiver_;
    #else
...
int main(int argc, char** argv) {	
	...
	slogger->print() << "| " << tools::cyan("Message name") << "       : " << tools::yellow("MAPEM");
