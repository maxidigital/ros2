 ...
 *
 */
#ifndef DSRC_V2_IVIM_PDU_DESCRIPTIONS_WER_DECODER
#define DSRC_V2_IVIM_PDU_DESCRIPTIONS_WER_DECODER
...
namespace wind
{
    namespace decoder_dsrc_v2_ivim_pdu_descriptions
    {
        ...
        public:
            ...
            #if WIND_ROS_VERSION == 1
              bool decode(dsrc_v2_ivim_pdu_descriptions_msgs::IVIM* ros, const uint8_t *buffer);
            #else
              bool decode(dsrc_v2_ivim_pdu_descriptions_msgs::msg::IVIM* ros, const uint8_t *buffer);
            #endif
...
#endif //DSRC_V2_IVIM_PDU_DESCRIPTIONS_WER_DECODER