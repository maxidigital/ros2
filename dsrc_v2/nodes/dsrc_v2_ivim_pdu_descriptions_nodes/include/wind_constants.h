...
// Nodes names
#define RECEIVER_NODE_NAME       "dsrc_v2_ivim_pdu_descriptions_receiver"
#define SENDER_NODE_NAME         "dsrc_v2_ivim_pdu_descriptions_sender"

// Topics
#define RECEIVER_ROS_TOPIC        "/IVIM_in"
#define SENDER_ROS_TOPIC          "/IVIM_out"

// Network
#define DEFAULT_SENDER_IP          "127.0.0.1" 
#define DEFAULT_SENDER_UDP_PORT    1111          
#define DEFAULT_RECEIVER_UDP_PORT  2006
