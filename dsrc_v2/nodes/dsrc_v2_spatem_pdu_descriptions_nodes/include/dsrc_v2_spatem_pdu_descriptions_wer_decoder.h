 ...
 *
 */
#ifndef DSRC_V2_SPATEM_PDU_DESCRIPTIONS_WER_DECODER
#define DSRC_V2_SPATEM_PDU_DESCRIPTIONS_WER_DECODER
...
namespace wind
{
    namespace decoder_dsrc_v2_spatem_pdu_descriptions
    {
        ...
        public:
            ...
            #if WIND_ROS_VERSION == 1
              bool decode(dsrc_v2_spatem_pdu_descriptions_msgs::SPATEM* ros, const uint8_t *buffer);
            #else
              bool decode(dsrc_v2_spatem_pdu_descriptions_msgs::msg::SPATEM* ros, const uint8_t *buffer);
            #endif
...
#endif //DSRC_V2_SPATEM_PDU_DESCRIPTIONS_WER_DECODER