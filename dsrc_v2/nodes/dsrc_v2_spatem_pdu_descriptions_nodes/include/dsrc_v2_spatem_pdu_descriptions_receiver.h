...
namespace wind_ros
{
	...
	#else
	  class Receiver_dsrc_v2_spatem_pdu_descriptions : public rclcpp::Node
    #endif
    {
    public:
		 ...
		 */
        #if WIND_ROS_VERSION == 1
		Receiver_dsrc_v2_spatem_pdu_descriptions() : node_handle_("~"),
			publisher_(nullptr),
			...
			busy_(false)
		#else
		Receiver_dsrc_v2_spatem_pdu_descriptions() : Node("receiver_dsrc_v2_spatem_pdu_descriptions"),
			messages_counter_(0),
			slogger_(nullptr),
			debug_(false),
			busy_(false)
    ...
    private:        	
		...
		#else
		  rclcpp::Publisher<dsrc_v2_spatem_pdu_descriptions_msgs::msg::SPATEM>::SharedPtr publisher_;
          rclcpp::Publisher<dsrc_v2_spatem_pdu_descriptions_msgs::msg::SPATEM>::SharedPtr mirror_publisher_;
		#endif
		...
		bool            debug_;
		bool            busy_;
		wind::decoder_dsrc_v2_spatem_pdu_descriptions::WerDecoder* decoder_;
    };
