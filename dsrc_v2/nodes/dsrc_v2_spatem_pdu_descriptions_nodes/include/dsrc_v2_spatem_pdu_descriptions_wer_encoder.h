 ...
 *
 */
#ifndef DSRC_V2_SPATEM_PDU_DESCRIPTIONS_WER_ENCODER
#define DSRC_V2_SPATEM_PDU_DESCRIPTIONS_WER_ENCODER
...
namespace wind
{
    namespace encoder_dsrc_v2_spatem_pdu_descriptions
    {
        ...
        public:
            ...
            #if WIND_ROS_VERSION == 1
              int encode(const dsrc_v2_spatem_pdu_descriptions_msgs::SPATEM::ConstPtr& ros, const uint8_t *buffer);
            #else
              int encode(const std::shared_ptr<dsrc_v2_spatem_pdu_descriptions_msgs::msg::SPATEM>& ros, const uint8_t *buffer);
              //int encode(const dsrc_v2_spatem_pdu_descriptions_msgs::msg::SPATEM* ros, const uint8_t *buffer);
            #endif
