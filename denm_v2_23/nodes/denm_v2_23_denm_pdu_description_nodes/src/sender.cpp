...
public:
    ...
    void run() {
        // Modules
          ...
          wind::wind_ros::Sender_denm_v2_23_denm_pdu_description* sender_ = new wind::wind_ros::Sender_denm_v2_23_denm_pdu_description();
		#else
          slogger_->print() << "Starting " << tools::cyan("ROS2") << " node";
		  auto sender_ = std::make_shared<wind::wind_ros::Sender_denm_v2_23_denm_pdu_description>();
	    #endif
