 ...
 *
 */
#ifndef CPM_V1_23_CPM_PDU_DESCRIPTIONS_SENDER_H
#define CPM_V1_23_CPM_PDU_DESCRIPTIONS_SENDER_H
...
#if WIND_ROS_VERSION == 1
  class Sender_cpm_v1_23_cpm_pdu_descriptions
#else
  class Sender_cpm_v1_23_cpm_pdu_descriptions : public rclcpp::Node
#endif
{
...
public:
	...
	#if WIND_ROS_VERSION == 1
     Sender_cpm_v1_23_cpm_pdu_descriptions() {	
	#else
     Sender_cpm_v1_23_cpm_pdu_descriptions() : rclcpp::Node(SENDER_NODE_NAME) {
    #endif		
		messages_counter_ = 0;
		failed_ = 0;
...
private:
    ...
    const int              INDICATION_HEADER_SIZE_ = 52;
	 ...
	 void callback(const cpm_v1_23_cpm_pdu_descriptions_msgs::CollectivePerceptionMessage::ConstPtr& msg);	 
	#else
	 rclcpp::Subscription<cpm_v1_23_cpm_pdu_descriptions_msgs::msg::CollectivePerceptionMessage>::SharedPtr subscriber;
     void callback(const std::shared_ptr<cpm_v1_23_cpm_pdu_descriptions_msgs::msg::CollectivePerceptionMessage>& msg);	 
    #endif
	...
	wind::encoder_cpm_v1_23_cpm_pdu_descriptions::WerEncoder* encoder_;
...
#endif //CPM_V1_23_CPM_PDU_DESCRIPTIONS_SENDER_H